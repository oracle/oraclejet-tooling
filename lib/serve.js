...
let serve = module.exports = (platform, options) => 
{
  ...
  return new Promise((resolve) => 
  {
    ...
    let validDefaultServeConfig = valid.getDefaultServeConfig();
    let validDefaultPlatformsConfig = valid.getDefaultPlatformsConfig();
    ...
    console.log(`Target: ${validOptions.port}`);
...
function validateBuild(build)
{
  ...
  {
    let defaultBuild = config("defaultServeConfig").options.build;
