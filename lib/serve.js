  ...
  if (config.get('serve').build) {
    ...
    return () => {
      ...
      Object.assign(buildConfig, {
        ...
        nosass: serveConfig.nosass,
        sassCompile: serveConfig.sassCompile,
        pcssCompile: serveConfig.pcssCompile,
        destination: serveConfig.destination,
        userOptions: serveConfig.userOptions,
        notscompile: serveConfig.notscompile,
        dbg: serveConfig.dbg,
        optimize: serveConfig.optimize,
        defaultCssvars: serveConfig.defaultCssvars
      });
