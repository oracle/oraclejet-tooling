...
function _getBuiltComponentPath(componentName, opts) {
  ...
  const omitComponentVersion = opts && opts[CONSTANTS.OMIT_COMPONENT_VERSION_FLAG];
  ...
  if (!componentWebDirPath) {
    ...
    componentWebDirPath = shouldBeVersionless ? unVersionedComponentWebDirPath : versionedComponentWebDirPath;
  }
