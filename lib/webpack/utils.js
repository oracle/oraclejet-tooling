...
function copyRequiredAltaFilesToStaging(context) {
  ...
  requiredFolders.forEach((folder) => {
    ...
    const useUnversionedStructure = context.opts[constants.OMIT_COMPONENT_VERSION_FLAG] ||
      ojetUtils.getOraclejetConfigJson().unversioned;
    destPath = !useUnversionedStructure ? path.join(destPath, `${ojetUtils.getJETVersion()}`, folder) : path.join(destPath, folder);
