          ...
          fileList: [
            {
              ...
              src: [
                ...
                `!${paths.src.javascript}/main-debug-paths-windows.json`,
                `!${paths.src.javascript}/main-release-paths-windows.json`,
    ...
    hybrid: {
      ...
      injectPaths: (paths) => {
        return {
          ...
          mainReleasePaths: `${paths.src.common}/${paths.src.javascript}/main-release-paths.json`,
          mainDebugPathsWindows: `${paths.src.common}/${paths.src.javascript}/main-debug-paths-windows.json`,
          mainReleasePathsWindows: `${paths.src.common}/${paths.src.javascript}/main-release-paths-windows.json`,
        };
      },
