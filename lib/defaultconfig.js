  ...
  build: {
    ...
    terser: paths => ({
      fileList: [
        ...
        {
          cwd: `${paths.staging.stagingPath}/${paths.src.typescript}`,
          src: ['**/*.js'],
          dest: `${paths.staging.stagingPath}/${paths.src.javascript}`
        },
        {
      ...
      fileList: [
        {
          ...
          src: [
            ...
            `!${paths.src.javascript}/path_mapping.json`,
    ...
    watch: paths => ({
      sourceFiles:
      {
        files: [
          ...
          `${paths.src.common}/${paths.src.typescript}/!(libs)/**/*.ts`,
          `${paths.src.common}/${paths.src.typescript}/!(libs)/**/*.json`,
          `${paths.src.common}/${paths.src.typescript}/!(libs)/**/*.css`,
