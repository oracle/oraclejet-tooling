...
util.getPathToTsConfig = (appPath) => {
  ...
  const customPath = this.getOraclejetConfigJson(appPath).paths.source.tsconfig;
...
util.getMonoPackMemberNameList = (packComponentJson) => {
  ...
  contentsArray.forEach((content) => {
    // Do not include mono-pack content of type module.
    // They are not components that should be processed
    // during the building or packaging process.
